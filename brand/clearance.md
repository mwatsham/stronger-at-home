...
|---|---|---|---|
| `Stronger at Home Physiotherapy` formal trading name and `Stronger@Home` display wordmark | approved for sole-trader physiotherapy use; UKIPO registration deferred | The 2026-08-06 preliminary screen found no exact live match but identified `STRONGER` UK00003586606 and `Everyday Stronger` UK00003957710 in Class 44. On 2026-08-17, the project sponsor accepted the residual risk and the physiotherapy focus as sufficient practical differentiation. See `brand/trademark-screening.md`. | Public name use is permitted within the current physiotherapy offer. This is not legal clearance or registration: do not use `®` or claim registered rights. Review after an objection, material expansion beyond physiotherapy, licensing, ownership change, or a decision to seek registration. |
...
| Public contact fields | approved; public email two-way delivery and authentication verified; website content unverified | Approved by project sponsor on 2026-08-05: mobile `+447843497871`; email `melanie@stronger-at-home.co.uk`; address `11 Mospey Crescent, Epsom, Surrey, KT17 4LZ`; preferred method email; website `www.stronger-at-home.co.uk`; on 2026-08-06 the public mailbox passed a two-way test with SPF, aligned DKIM and DMARC at Gmail | Email operational gate resolved. Do not publish the website until its content is operationally verified. |
...
On 2026-08-06, `melanie@stronger-at-home.co.uk` completed a separate two-way
test. Gmail's received-message headers recorded SPF pass, aligned DKIM pass for
`stronger-at-home.co.uk`, an additional DKIM pass for `secureserver.net`, and
DMARC pass at `p=quarantine`. The public-email operational gate is resolved.
