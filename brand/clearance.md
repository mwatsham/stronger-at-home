...
| `stronger-at-home.co.uk` preferred domain | registered; cPanel account attachment and control unverified | Project sponsor confirmed registration on 2026-08-05; successful cPanel domain inspection and operational control verification remain required | Do not print, publish or build around the domain before control is verified. Domain status is not trademark clearance. |
...
| Public contact fields | approved; domain-based delivery unverified | Approved by project sponsor on 2026-08-05: mobile `+447843497871`; email `melanie@stronger-at-home.co.uk`; address `11 Mospey Crescent, Epsom, Surrey, KT17 4LZ`; preferred method email; website `www.stronger-at-home.co.uk` | Do not publish the email or website until domain and mailbox control are operationally verified. |
