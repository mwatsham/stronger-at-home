...
| D-24 | The external Titan Email mailbox `melanie@stronger-at-home.co.uk` exists; authoritative DNS still points MX and SPF to SecureServer, so Titan routing, send/receive delivery and DKIM remain verification gates. | approved | Project sponsor | 2026-08-05 |
