...
| D-24 | The external Titan Email mailbox `melanie@stronger-at-home.co.uk` exists; Titan MX and SPF have propagated. Send/receive delivery and custom DKIM remain verification gates; live MX priorities `0`/`10` differ from Titan's published `10`/`20` defaults. | approved | Project sponsor | 2026-08-05 |
